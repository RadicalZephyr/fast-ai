...
public: //Usage Section
    ...
    void setEnemyBase(BWAPI::Unit *base) {
        enemyBase = base;
    }
    BWAPI::Unit *getEnemyBase(void) {
        return enemyBase;
    }

    void setEnemyStartLocation(BWAPI::TilePosition tile) {
        enemyStartLocation = tile;
    }
    BWAPI::TilePosition getEnemyStartLocation(void) {
